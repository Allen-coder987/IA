...
from modules.yolov5.utils.metrics import bbox_iou
from modules.yolov5.utils.torch_utils import de_parallel
...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        print(f"p shape: {[pp.shape for pp in p]}")  # 打印每个尺度的预测形状
