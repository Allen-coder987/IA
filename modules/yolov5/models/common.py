...
from modules.yolov5.utils import TryExcept
from modules.yolov5.utils.dataloaders import exif_transpose, letterbox
...
from modules.yolov5.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            from modules.yolov5.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from modules.yolov5.utils.downloads import is_url
